...
<div class="col-span-1">
  ...
  <label for="name" class="text-[#888b95] text-sm m-2 ">
    ...
    Active Ingridients
      ...
      <input type="text" class="input" name="active" id='active' value="{{ old('active') }}" required>
      <label for="name" class="text-[#888b95] text-sm m-2 ">
    Approved use of Medication
  </label>
      <textarea  class="input h-40 p-5 rounded-lg" name="indication" id='indication' value="{{ old('indication') }}" required placeholder="e.g Fever, malaria etc"></textarea>
    <label for="name" class="text-[#888b95] text-sm m-2 ">
    Manufacturer
  </label>
